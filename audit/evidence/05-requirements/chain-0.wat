;; commit bd985d7; emitted by audit/scripts/arch/req-probes.ts for chain-0.hd; 2026-09-25T20:54:22.993Z
(module
...
(func $hd.suspension_drive (param $frame (ref null $hd.suspension)) (result anyref)
  ...
  (elem declare func $fv0 $fv1 $fv2 $fv3 $fv4 $fv5 $fv6 $fv7 $fv8 $fv9 $fv10)

  (func $f0 (export "c10") (param $l0 i32) (result i32)
    (call $hd.add_i32 (local.get $l0) (i32.const 1))
  )

  (func $fv0 (type $sig0) (param $env anyref) (param $l0 i32) (result i32)
    (call $f0 (local.get $l0))
  )

  (func $f1 (export "c9") (param $l0 i32) (result i32)
    (call $f0 (local.get $l0))
  )
  ...
  (func $f2 (export "c8") (param $l0 i32) (result i32)
    (call $f1 (local.get $l0))
  )
  ...
  (func $f3 (export "c7") (param $l0 i32) (result i32)
    (call $f2 (local.get $l0))
  )
  ...
  (func $f4 (export "c6") (param $l0 i32) (result i32)
    (call $f3 (local.get $l0))
  )

  (func $fv4 (type $sig0) (param $env anyref) (param $l0 i32) (result i32)
    (call $f4 (local.get $l0))
  )

  (func $f5 (export "c5") (param $l0 i32) (result i32)
    (call $f4 (local.get $l0))
  )

  (func $fv5 (type $sig0) (param $env anyref) (param $l0 i32) (result i32)
    (call $f5 (local.get $l0))
  )

  (func $f6 (export "c4") (param $l0 i32) (result i32)
    (call $f5 (local.get $l0))
  )

  (func $fv6 (type $sig0) (param $env anyref) (param $l0 i32) (result i32)
    (call $f6 (local.get $l0))
  )

  (func $f7 (export "c3") (param $l0 i32) (result i32)
    (call $f6 (local.get $l0))
  )

  (func $fv7 (type $sig0) (param $env anyref) (param $l0 i32) (result i32)
    (call $f7 (local.get $l0))
  )

  (func $f8 (export "c2") (param $l0 i32) (result i32)
    (call $f7 (local.get $l0))
  )

  (func $fv8 (type $sig0) (param $env anyref) (param $l0 i32) (result i32)
    (call $f8 (local.get $l0))
  )

  (func $f9 (export "c1") (param $l0 i32) (result i32)
    (call $f8 (local.get $l0))
  )

  (func $fv9 (type $sig0) (param $env anyref) (param $l0 i32) (result i32)
  ...
  (func $f10 (export "main") (result i32)
    ...
    (block $break0
      (loop $loop0
        (br_if $break0 (i32.eqz (block (result i32) (local.set $tmp4 (if (result i32) (i32.lt_s (local.get $l0) (i32.const 200000)) (then (i32.const -1)) (else (if (result i32) (i32.gt_s (local.get $l0) (i32.const 200000)) (then (i32.const 1)) (else (i32.const 0)))))) (i32.eq (local.get $tmp4) (i32.const -1)))))
        (local.set $l1 (block (result i32)
          (local.set $tmp2 (call $hd.add_i32 (local.get $l1) (call $f9 (block (result i32)
          ...
          (local.set $tmp3 (i32.const 1000003))
          (if (i32.eqz (local.get $tmp3))
            (then (call $hd.panic (i32.const 1)) unreachable))
          (i32.rem_s (local.get $tmp2) (local.get $tmp3))
        ))
        (local.set $l0 (call $hd.add_i32 (local.get $l0) (i32.const 1)))
        (br $loop0)
      )
    )
    (local.get $l1)
