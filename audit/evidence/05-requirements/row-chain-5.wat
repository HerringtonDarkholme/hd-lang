;; commit bd985d7; emitted by audit/scripts/arch/req-probes.ts for row-chain-5.hd; 2026-09-25T20:54:26.259Z
(module
  (import "hd" "panic" (func $hd.panic (param i32)))
  (rec
    (type $sig0 (func (param anyref) (param i32) (param (ref null $trait0)) (param (ref null $trait1)) (param (ref null $trait2)) (param (ref null $trait3)) (param (ref null $trait4)) (result i32)))
    ...
    (type $tsig5_0 (func (param anyref) (param anyref) (result (ref null $hd.bytes))))
    (type $tsig6_0 (func (param anyref) (param anyref) (param anyref) (result i32)))
    (type $tsig7_0 (func (param anyref) (param anyref) (param anyref) (result (ref null $hd.variant))))
    (type $tsig8_0 (func (param anyref) (param anyref)))
    (type $tsig9_0 (func (param anyref) (param anyref) (result (ref null $hd.variant))))
...
(func $hd.suspension_drive (param $frame (ref null $hd.suspension)) (result anyref)
  ...
  (elem declare func $fv0 $fv1 $fv2 $fv3 $fv4 $fv5 $fv6 $fv7 $fv8 $fv9 $fv10 $fv11 $fv12 $fv13 $fv14 $fv15 $fv16 $adapt0 $tadapt0_0 $tadapt1_0 $tadapt2_0 $tadapt3_0 $tadapt4_0)

  (func $f0 (export "leaf") (param $l0 i32) (param $provider0 (ref null $trait0)) (param $provider1 (ref null $trait1)) (param $provider2 (ref null $trait2)) (param $provider3 (ref null $trait3)) (param $provider4 (ref null $trait4)) (result i32)
    ...
    (call $hd.add_i32 (call $hd.add_i32 (call $hd.add_i32 (call $hd.add_i32 (call $hd.add_i32 (local.get $l0) (block (result i32)
  ...
  (func $fv0 (type $sig0) (param $env anyref) (param $l0 i32) (param $provider0 (ref null $trait0)) (param $provider1 (ref null $trait1)) (param $provider2 (ref null $trait2)) (param $provider3 (ref null $trait3)) (param $provider4 (ref null $trait4)) (result i32)
    (call $f0 (local.get $l0) (local.get $provider0) (local.get $provider1) (local.get $provider2) (local.get $provider3) (local.get $provider4))
  )
  ...
  (func $f11 (export "main") (result i32)
    ...
    (block (result i32)
      ...
      (block $break0
        (loop $loop0
          (br_if $break0 (i32.eqz (block (result i32) (local.set $tmp14 (if (result i32) (i32.lt_s (local.get $l5) (i32.const 200000)) (then (i32.const -1)) (else (if (result i32) (i32.gt_s (local.get $l5) (i32.const 200000)) (then (i32.const 1)) (else (i32.const 0)))))) (i32.eq (local.get $tmp14) (i32.const -1)))))
          (local.set $l6 (block (result i32)
            (local.set $tmp12 (call $hd.add_i32 (local.get $l6) (call $f10 (struct.new $closure1 (ref.func $adapt0) (struct.new $closure0 (ref.func $fv0) (ref.null any))) (block (result i32)
            (local.set $tmp10 (local.get $l5))
            (local.set $tmp11 (i32.const 7))
            (if (i32.eqz (local.get $tmp11))
              (then (call $hd.panic (i32.const 1)) unreachable))
            (i32.rem_s (local.get $tmp10) (local.get $tmp11))
          ) (struct.new $hd.providers (i32.const 4) (local.get $l0) (struct.new $hd.providers (i32.const 3) (local.get $l1) (struct.new $hd.providers (i32.const 2) (local.get $l2) (struct.new $hd.providers (i32.const 1) (local.get $l3) (struct.new $hd.providers (i32.const 0) (local.get $l4) (ref.null $hd.providers)))))))))
            (local.set $tmp13 (i32.const 1000003))
            (if (i32.eqz (local.get $tmp13))
              (then (call $hd.panic (i32.const 1)) unreachable))
            (i32.rem_s (local.get $tmp12) (local.get $tmp13))
          ))
          (local.set $l5 (call $hd.add_i32 (local.get $l5) (i32.const 1)))
          (br $loop0)
        )
      )
      (local.get $l6)
  ...
  (func $adapt0 (type $sig1) (param $env anyref) (param $a0 i32) (param $p0 (ref null $hd.providers)) (result i32)
    (call_ref $sig0 (struct.get $closure0 $closure0env (ref.cast (ref $closure0) (local.get $env))) (local.get $a0) (ref.cast (ref null $trait0) (call $hd.provider_get (call $hd.provider_concat (local.get $p0) (ref.null $hd.providers)) (i32.const 4))) (ref.cast (ref null $trait1) (call $hd.provider_get (call $hd.provider_concat (local.get $p0) (ref.null $hd.providers)) (i32.const 3))) (ref.cast (ref null $trait2) (call $hd.provider_get (call $hd.provider_concat (local.get $p0) (ref.null $hd.providers)) (i32.const 2))) (ref.cast (ref null $trait3) (call $hd.provider_get (call $hd.provider_concat (local.get $p0) (ref.null $hd.providers)) (i32.const 1))) (ref.cast (ref null $trait4) (call $hd.provider_get (call $hd.provider_concat (local.get $p0) (ref.null $hd.providers)) (i32.const 0))) (struct.get $closure0 $closure0fn (ref.cast (ref $closure0) (local.get $env))))
  )
