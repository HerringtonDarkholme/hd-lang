;; commit bd985d7; command: hd build --wat audit/probes/arch/requirements/abi.hd; date: 2026-09-25T20:50:10Z
(module
  ...
  (rec
    ...
    (type $sig2 (func (param anyref) (param (ref null $hd.providers)) (result i32)))
    (type $sig3 (func (param anyref) (param (ref null $closure2)) (param (ref null $hd.providers)) (result i32)))
    (type $sig4 (func (param anyref) (param (ref null $closure2)) (param (ref null $trait0)) (param (ref null $hd.providers)) (result i32)))
    (type $sig5 (func (param anyref) (param (ref null $trait1)) (result i32)))
    (type $sig6 (func (param anyref) (result i32)))
    (type $sig7 (func (param anyref) (param (ref null $d0)) (result i32)))
    (type $sig8 (func (param anyref) (param (ref null $d1)) (result i32)))
...
(func $hd.suspension_drive (param $frame (ref null $hd.suspension)) (result anyref)
  ...
  (elem declare func $fv0 $fv1 $fv2 $fv3 $fv4 $fv5 $fv6 $fv7 $adapt0 $tadapt0_0 $tadapt1_0)

  (func $f0 (export "one") (param $provider0 (ref null $trait0)) (result i32)
  ...
  (func $f1 (export "two") (param $provider0 (ref null $trait1)) (param $provider1 (ref null $trait0)) (result i32)
    (local $tmp0 (ref null $trait0))
  ...
  (func $f2 (param $l0 (ref null $closure2)) (param $provider0 (ref null $hd.providers)) (result i32)
    (local $tmp0 (ref null $closure2))
    (block (result i32)
      (local.set $tmp0 (local.get $l0))
      (call_ref $sig2
        (struct.get $closure2 $closure2env (local.get $tmp0))
        (local.get $provider0)
        (struct.get $closure2 $closure2fn (local.get $tmp0)))
    )
  )

  (func $fv2 (type $sig3) (param $env anyref) (param $l0 (ref null $closure2)) (param $provider0 (ref null $hd.providers)) (result i32)
    (call $f2 (local.get $l0) (local.get $provider0))
  )

  (func $f3 (param $l0 (ref null $closure2)) (param $l1 (ref null $trait0)) (param $provider0 (ref null $hd.providers)) (result i32)
  ...
  (func $fv3 (type $sig4) (param $env anyref) (param $l0 (ref null $closure2)) (param $l1 (ref null $trait0)) (param $provider0 (ref null $hd.providers)) (result i32)
    (call $f3 (local.get $l0) (local.get $l1) (local.get $provider0))
  )

  (func $f4 (export "uses_subtract") (param $provider0 (ref null $trait1)) (result i32)
    (local $tmp0 (ref null $d0))
    (local $tmp1 i32)
    (call $f3 (struct.new $closure2 (ref.func $adapt0) (struct.new $closure1 (ref.func $fv1) (ref.null any))) (block (result (ref null $trait0))
      (local.set $tmp0 (block (result (ref null $d0))
      (local.set $tmp1 (i32.const 5))
      (struct.new $d0 (local.get $tmp1))
    ))
      (struct.new $trait0 (local.get $tmp0) (ref.null $hd.list) (ref.func $tadapt0_0))
    ) (struct.new $hd.providers (i32.const 1) (local.get $provider0) (ref.null $hd.providers)))
  )

  (func $fv4 (type $sig5) (param $env anyref) (param $provider0 (ref null $trait1)) (result i32)
    (call $f4 (local.get $provider0))
  )

  (func $f5 (export "main") (result i32)
    ...
    (block (result i32)
      ...
      (local.set $tmp3 (i32.const 2))
      (struct.new $d1 (local.get $tmp3))
    ))
      (struct.new $trait1 (local.get $tmp2) (ref.null $hd.list) (ref.func $tadapt1_0))
    ))
      (call $hd.sub_i32 (call $hd.add_i32 (call $hd.sub_i32 (call $hd.add_i32 (call $hd.sub_i32 (call $hd.add_i32 (call $f0 (local.get $l0)) (call $f1 (local.get $l1) (local.get $l0))) (i32.const 42)) (call $f2 (struct.new $closure2 (ref.func $adapt0) (struct.new $closure1 (ref.func $fv1) (ref.null any))) (struct.new $hd.providers (i32.const 1) (local.get $l1) (struct.new $hd.providers (i32.const 0) (local.get $l0) (ref.null $hd.providers))))) (i32.const 42)) (call $f4 (local.get $l1))) (i32.const 7))
    )
  )

  (func $fv5 (type $sig6) (param $env anyref)  (result i32)
    (call $f5)
  )

  (func $f6 (param $l0 (ref null $d0)) (result i32)
    (struct.get $d0 $d0f0 (local.get $l0))
  )

  (func $fv6 (type $sig7) (param $env anyref) (param $l0 (ref null $d0)) (result i32)
    (call $f6 (local.get $l0))
  )

  (func $f7 (param $l0 (ref null $d1)) (result i32)
    (struct.get $d1 $d1f0 (local.get $l0))
  )

  (func $fv7 (type $sig8) (param $env anyref) (param $l0 (ref null $d1)) (result i32)
    (call $f7 (local.get $l0))
  )

  (func $adapt0 (type $sig2) (param $env anyref) (param $p0 (ref null $hd.providers)) (result i32)
  ...
  (func $tadapt0_0 (type $tsig0_0) (param $self anyref) (param $dictionary anyref)  (result i32)
    (call $f6 (ref.cast (ref null $d0) (local.get $self)))
  )
  
  (func $tadapt1_0 (type $tsig1_0) (param $self anyref) (param $dictionary anyref)  (result i32)
    (call $f7 (ref.cast (ref null $d1) (local.get $self)))
  )
)
