;; commit bd985d7; emitted by audit/scripts/arch/req-probes.ts for row-chain-10.hd; 2026-09-25T20:54:28.588Z
(module
  ...
  (rec
    ...
    (type $sig1 (func (param anyref) (param i32) (param (ref null $hd.providers)) (result i32)))
    (type $sig2 (func (param anyref) (param (ref null $closure1)) (param i32) (param (ref null $hd.providers)) (result i32)))
    (type $sig3 (func (param anyref) (result i32)))
    (type $sig4 (func (param anyref) (param (ref null $d0)) (result i32)))
    (type $sig5 (func (param anyref) (param (ref null $d1)) (result i32)))
    (type $sig6 (func (param anyref) (param (ref null $d2)) (result i32)))
    (type $sig7 (func (param anyref) (param (ref null $d3)) (result i32)))
    (type $sig8 (func (param anyref) (param (ref null $d4)) (result i32)))
    (type $sig9 (func (param anyref) (param (ref null $d5)) (result i32)))
    (type $sig10 (func (param anyref) (param (ref null $d6)) (result i32)))
    (type $sig11 (func (param anyref) (param (ref null $d7)) (result i32)))
    (type $sig12 (func (param anyref) (param (ref null $d8)) (result i32)))
    (type $sig13 (func (param anyref) (param (ref null $d9)) (result i32)))
    ...
    (type $closure13 (struct
      (field $closure13fn (ref $sig13))
      (field $closure13env anyref)))
...
(func $hd.suspension_drive (param $frame (ref null $hd.suspension)) (result anyref)
  ...
  (elem declare func $fv0 $fv1 $fv2 $fv3 $fv4 $fv5 $fv6 $fv7 $fv8 $fv9 $fv10 $fv11 $fv12 $fv13 $fv14 $fv15 $fv16 $fv17 $fv18 $fv19 $fv20 $fv21 $adapt0 $tadapt0_0 $tadapt1_0 $tadapt2_0 $tadapt3_0 $tadapt4_0 $tadapt5_0 $tadapt6_0 $tadapt7_0 $tadapt8_0 $tadapt9_0)

  (func $f0 (export "leaf") (param $l0 i32) (param $provider0 (ref null $trait0)) (param $provider1 (ref null $trait9)) (param $provider2 (ref null $trait1)) (param $provider3 (ref null $trait2)) (param $provider4 (ref null $trait3)) (param $provider5 (ref null $trait4)) (param $provider6 (ref null $trait5)) (param $provider7 (ref null $trait6)) (param $provider8 (ref null $trait7)) (param $provider9 (ref null $trait8)) (result i32)
    (local $tmp0 (ref null $trait0))
    (local $tmp1 (ref null $trait1))
    (local $tmp2 (ref null $trait2))
    (local $tmp3 (ref null $trait3))
    (local $tmp4 (ref null $trait4))
    (local $tmp5 (ref null $trait5))
    (local $tmp6 (ref null $trait6))
    (local $tmp7 (ref null $trait7))
    (local $tmp8 (ref null $trait8))
    (local $tmp9 (ref null $trait9))
    (call $hd.add_i32 (call $hd.add_i32 (call $hd.add_i32 (call $hd.add_i32 (call $hd.add_i32 (call $hd.add_i32 (call $hd.add_i32 (call $hd.add_i32 (call $hd.add_i32 (call $hd.add_i32 (local.get $l0) (block (result i32)
      ...
      (local.set $tmp1 (local.get $provider2))
      (call_ref $tsig1_0
      (struct.get $trait1 $trait1value (local.get $tmp1))
      (local.get $tmp1)
      (struct.get $trait1 $trait1m0 (local.get $tmp1)))
    )) (block (result i32)
      (local.set $tmp2 (local.get $provider3))
      (call_ref $tsig2_0
      (struct.get $trait2 $trait2value (local.get $tmp2))
      (local.get $tmp2)
      (struct.get $trait2 $trait2m0 (local.get $tmp2)))
    )) (block (result i32)
      (local.set $tmp3 (local.get $provider4))
      (call_ref $tsig3_0
      (struct.get $trait3 $trait3value (local.get $tmp3))
      (local.get $tmp3)
      (struct.get $trait3 $trait3m0 (local.get $tmp3)))
    )) (block (result i32)
      (local.set $tmp4 (local.get $provider5))
      (call_ref $tsig4_0
      (struct.get $trait4 $trait4value (local.get $tmp4))
      (local.get $tmp4)
      (struct.get $trait4 $trait4m0 (local.get $tmp4)))
    )) (block (result i32)
      (local.set $tmp5 (local.get $provider6))
      (call_ref $tsig5_0
      (struct.get $trait5 $trait5value (local.get $tmp5))
      (local.get $tmp5)
      (struct.get $trait5 $trait5m0 (local.get $tmp5)))
    )) (block (result i32)
      (local.set $tmp6 (local.get $provider7))
      (call_ref $tsig6_0
      (struct.get $trait6 $trait6value (local.get $tmp6))
      (local.get $tmp6)
      (struct.get $trait6 $trait6m0 (local.get $tmp6)))
    )) (block (result i32)
      (local.set $tmp7 (local.get $provider8))
      (call_ref $tsig7_0
      (struct.get $trait7 $trait7value (local.get $tmp7))
      (local.get $tmp7)
      (struct.get $trait7 $trait7m0 (local.get $tmp7)))
    )) (block (result i32)
      (local.set $tmp8 (local.get $provider9))
      (call_ref $tsig8_0
      (struct.get $trait8 $trait8value (local.get $tmp8))
      (local.get $tmp8)
      (struct.get $trait8 $trait8m0 (local.get $tmp8)))
    )) (block (result i32)
      (local.set $tmp9 (local.get $provider1))
      (call_ref $tsig9_0
      (struct.get $trait9 $trait9value (local.get $tmp9))
      (local.get $tmp9)
      (struct.get $trait9 $trait9m0 (local.get $tmp9)))
    ))
  )
  ...
  (func $f1 (param $l0 (ref null $closure1)) (param $l1 i32) (param $provider0 (ref null $hd.providers)) (result i32)
  ...
  (func $fv1 (type $sig2) (param $env anyref) (param $l0 (ref null $closure1)) (param $l1 i32) (param $provider0 (ref null $hd.providers)) (result i32)
    (call $f1 (local.get $l0) (local.get $l1) (local.get $provider0))
  )

  (func $f2 (param $l0 (ref null $closure1)) (param $l1 i32) (param $provider0 (ref null $hd.providers)) (result i32)
    (call $f1 (local.get $l0) (local.get $l1) (local.get $provider0))
  )

  (func $fv2 (type $sig2) (param $env anyref) (param $l0 (ref null $closure1)) (param $l1 i32) (param $provider0 (ref null $hd.providers)) (result i32)
    (call $f2 (local.get $l0) (local.get $l1) (local.get $provider0))
  )

  (func $f3 (param $l0 (ref null $closure1)) (param $l1 i32) (param $provider0 (ref null $hd.providers)) (result i32)
    (call $f2 (local.get $l0) (local.get $l1) (local.get $provider0))
  )

  (func $fv3 (type $sig2) (param $env anyref) (param $l0 (ref null $closure1)) (param $l1 i32) (param $provider0 (ref null $hd.providers)) (result i32)
    (call $f3 (local.get $l0) (local.get $l1) (local.get $provider0))
  )

  (func $f4 (param $l0 (ref null $closure1)) (param $l1 i32) (param $provider0 (ref null $hd.providers)) (result i32)
    (call $f3 (local.get $l0) (local.get $l1) (local.get $provider0))
  )

  (func $fv4 (type $sig2) (param $env anyref) (param $l0 (ref null $closure1)) (param $l1 i32) (param $provider0 (ref null $hd.providers)) (result i32)
    (call $f4 (local.get $l0) (local.get $l1) (local.get $provider0))
  )

  (func $f5 (param $l0 (ref null $closure1)) (param $l1 i32) (param $provider0 (ref null $hd.providers)) (result i32)
    (call $f4 (local.get $l0) (local.get $l1) (local.get $provider0))
  )

  (func $fv5 (type $sig2) (param $env anyref) (param $l0 (ref null $closure1)) (param $l1 i32) (param $provider0 (ref null $hd.providers)) (result i32)
    (call $f5 (local.get $l0) (local.get $l1) (local.get $provider0))
  )

  (func $f6 (param $l0 (ref null $closure1)) (param $l1 i32) (param $provider0 (ref null $hd.providers)) (result i32)
    (call $f5 (local.get $l0) (local.get $l1) (local.get $provider0))
  )

  (func $fv6 (type $sig2) (param $env anyref) (param $l0 (ref null $closure1)) (param $l1 i32) (param $provider0 (ref null $hd.providers)) (result i32)
    (call $f6 (local.get $l0) (local.get $l1) (local.get $provider0))
  )

  (func $f7 (param $l0 (ref null $closure1)) (param $l1 i32) (param $provider0 (ref null $hd.providers)) (result i32)
    (call $f6 (local.get $l0) (local.get $l1) (local.get $provider0))
  )

  (func $fv7 (type $sig2) (param $env anyref) (param $l0 (ref null $closure1)) (param $l1 i32) (param $provider0 (ref null $hd.providers)) (result i32)
    (call $f7 (local.get $l0) (local.get $l1) (local.get $provider0))
  )

  (func $f8 (param $l0 (ref null $closure1)) (param $l1 i32) (param $provider0 (ref null $hd.providers)) (result i32)
    (call $f7 (local.get $l0) (local.get $l1) (local.get $provider0))
  )

  (func $fv8 (type $sig2) (param $env anyref) (param $l0 (ref null $closure1)) (param $l1 i32) (param $provider0 (ref null $hd.providers)) (result i32)
    (call $f8 (local.get $l0) (local.get $l1) (local.get $provider0))
  )

  (func $f9 (param $l0 (ref null $closure1)) (param $l1 i32) (param $provider0 (ref null $hd.providers)) (result i32)
    (call $f8 (local.get $l0) (local.get $l1) (local.get $provider0))
  )

  (func $fv9 (type $sig2) (param $env anyref) (param $l0 (ref null $closure1)) (param $l1 i32) (param $provider0 (ref null $hd.providers)) (result i32)
    (call $f9 (local.get $l0) (local.get $l1) (local.get $provider0))
  )

  (func $f10 (param $l0 (ref null $closure1)) (param $l1 i32) (param $provider0 (ref null $hd.providers)) (result i32)
    (call $f9 (local.get $l0) (local.get $l1) (local.get $provider0))
  )

  (func $fv10 (type $sig2) (param $env anyref) (param $l0 (ref null $closure1)) (param $l1 i32) (param $provider0 (ref null $hd.providers)) (result i32)
    (call $f10 (local.get $l0) (local.get $l1) (local.get $provider0))
  )

  (func $f11 (export "main") (result i32)
      ...
      (block $break0
        (loop $loop0
          ...
          (local.set $l11 (block (result i32)
            (local.set $tmp22 (call $hd.add_i32 (local.get $l11) (call $f10 (struct.new $closure1 (ref.func $adapt0) (struct.new $closure0 (ref.func $fv0) (ref.null any))) (block (result i32)
          ...
          ) (struct.new $hd.providers (i32.const 9) (local.get $l0) (struct.new $hd.providers (i32.const 8) (local.get $l9) (struct.new $hd.providers (i32.const 7) (local.get $l1) (struct.new $hd.providers (i32.const 6) (local.get $l2) (struct.new $hd.providers (i32.const 5) (local.get $l3) (struct.new $hd.providers (i32.const 4) (local.get $l4) (struct.new $hd.providers (i32.const 3) (local.get $l5) (struct.new $hd.providers (i32.const 2) (local.get $l6) (struct.new $hd.providers (i32.const 1) (local.get $l7) (struct.new $hd.providers (i32.const 0) (local.get $l8) (ref.null $hd.providers))))))))))))))
  ...
  (func $fv11 (type $sig3) (param $env anyref)  (result i32)
    (call $f11)
  )
  ...
  (func $fv12 (type $sig4) (param $env anyref) (param $l0 (ref null $d0)) (result i32)
    (call $f12 (local.get $l0))
  )

  (func $f13 (param $l0 (ref null $d1)) (result i32)
    (struct.get $d1 $d1f0 (local.get $l0))
  )

  (func $fv13 (type $sig5) (param $env anyref) (param $l0 (ref null $d1)) (result i32)
    (call $f13 (local.get $l0))
  )

  (func $f14 (param $l0 (ref null $d2)) (result i32)
    (struct.get $d2 $d2f0 (local.get $l0))
  )

  (func $fv14 (type $sig6) (param $env anyref) (param $l0 (ref null $d2)) (result i32)
    (call $f14 (local.get $l0))
  )

  (func $f15 (param $l0 (ref null $d3)) (result i32)
    (struct.get $d3 $d3f0 (local.get $l0))
  )

  (func $fv15 (type $sig7) (param $env anyref) (param $l0 (ref null $d3)) (result i32)
    (call $f15 (local.get $l0))
  )

  (func $f16 (param $l0 (ref null $d4)) (result i32)
    (struct.get $d4 $d4f0 (local.get $l0))
  )

  (func $fv16 (type $sig8) (param $env anyref) (param $l0 (ref null $d4)) (result i32)
    (call $f16 (local.get $l0))
  )

  (func $f17 (param $l0 (ref null $d5)) (result i32)
    (struct.get $d5 $d5f0 (local.get $l0))
  )

  (func $fv17 (type $sig9) (param $env anyref) (param $l0 (ref null $d5)) (result i32)
    (call $f17 (local.get $l0))
  )

  (func $f18 (param $l0 (ref null $d6)) (result i32)
    (struct.get $d6 $d6f0 (local.get $l0))
  )

  (func $fv18 (type $sig10) (param $env anyref) (param $l0 (ref null $d6)) (result i32)
    (call $f18 (local.get $l0))
  )

  (func $f19 (param $l0 (ref null $d7)) (result i32)
    (struct.get $d7 $d7f0 (local.get $l0))
  )

  (func $fv19 (type $sig11) (param $env anyref) (param $l0 (ref null $d7)) (result i32)
    (call $f19 (local.get $l0))
  )

  (func $f20 (param $l0 (ref null $d8)) (result i32)
    (struct.get $d8 $d8f0 (local.get $l0))
  )

  (func $fv20 (type $sig12) (param $env anyref) (param $l0 (ref null $d8)) (result i32)
    (call $f20 (local.get $l0))
  )

  (func $f21 (param $l0 (ref null $d9)) (result i32)
    (struct.get $d9 $d9f0 (local.get $l0))
  )

  (func $fv21 (type $sig13) (param $env anyref) (param $l0 (ref null $d9)) (result i32)
    (call $f21 (local.get $l0))
  )

  (func $adapt0 (type $sig1) (param $env anyref) (param $a0 i32) (param $p0 (ref null $hd.providers)) (result i32)
    (call_ref $sig0 (struct.get $closure0 $closure0env (ref.cast (ref $closure0) (local.get $env))) (local.get $a0) (ref.cast (ref null $trait0) (call $hd.provider_get (call $hd.provider_concat (local.get $p0) (ref.null $hd.providers)) (i32.const 9))) (ref.cast (ref null $trait9) (call $hd.provider_get (call $hd.provider_concat (local.get $p0) (ref.null $hd.providers)) (i32.const 8))) (ref.cast (ref null $trait1) (call $hd.provider_get (call $hd.provider_concat (local.get $p0) (ref.null $hd.providers)) (i32.const 7))) (ref.cast (ref null $trait2) (call $hd.provider_get (call $hd.provider_concat (local.get $p0) (ref.null $hd.providers)) (i32.const 6))) (ref.cast (ref null $trait3) (call $hd.provider_get (call $hd.provider_concat (local.get $p0) (ref.null $hd.providers)) (i32.const 5))) (ref.cast (ref null $trait4) (call $hd.provider_get (call $hd.provider_concat (local.get $p0) (ref.null $hd.providers)) (i32.const 4))) (ref.cast (ref null $trait5) (call $hd.provider_get (call $hd.provider_concat (local.get $p0) (ref.null $hd.providers)) (i32.const 3))) (ref.cast (ref null $trait6) (call $hd.provider_get (call $hd.provider_concat (local.get $p0) (ref.null $hd.providers)) (i32.const 2))) (ref.cast (ref null $trait7) (call $hd.provider_get (call $hd.provider_concat (local.get $p0) (ref.null $hd.providers)) (i32.const 1))) (ref.cast (ref null $trait8) (call $hd.provider_get (call $hd.provider_concat (local.get $p0) (ref.null $hd.providers)) (i32.const 0))) (struct.get $closure0 $closure0fn (ref.cast (ref $closure0) (local.get $env))))
  )
