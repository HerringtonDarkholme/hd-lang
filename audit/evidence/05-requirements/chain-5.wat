;; commit bd985d7; emitted by audit/scripts/arch/req-probes.ts for chain-5.hd; 2026-09-25T20:54:24.409Z
(module
...
(func $hd.suspension_drive (param $frame (ref null $hd.suspension)) (result anyref)
  ...
  (elem declare func $fv0 $fv1 $fv2 $fv3 $fv4 $fv5 $fv6 $fv7 $fv8 $fv9 $fv10 $fv11 $fv12 $fv13 $fv14 $fv15 $tadapt0_0 $tadapt1_0 $tadapt2_0 $tadapt3_0 $tadapt4_0)

  (func $f0 (export "c10") (param $l0 i32) (param $provider0 (ref null $trait0)) (param $provider1 (ref null $trait1)) (param $provider2 (ref null $trait2)) (param $provider3 (ref null $trait3)) (param $provider4 (ref null $trait4)) (result i32)
  ...
  (func $f1 (export "c9") (param $l0 i32) (param $provider0 (ref null $trait0)) (param $provider1 (ref null $trait1)) (param $provider2 (ref null $trait2)) (param $provider3 (ref null $trait3)) (param $provider4 (ref null $trait4)) (result i32)
    (call $f0 (local.get $l0) (local.get $provider0) (local.get $provider1) (local.get $provider2) (local.get $provider3) (local.get $provider4))
  )

  (func $fv1 (type $sig0) (param $env anyref) (param $l0 i32) (param $provider0 (ref null $trait0)) (param $provider1 (ref null $trait1)) (param $provider2 (ref null $trait2)) (param $provider3 (ref null $trait3)) (param $provider4 (ref null $trait4)) (result i32)
    (call $f1 (local.get $l0) (local.get $provider0) (local.get $provider1) (local.get $provider2) (local.get $provider3) (local.get $provider4))
  )

  (func $f2 (export "c8") (param $l0 i32) (param $provider0 (ref null $trait0)) (param $provider1 (ref null $trait1)) (param $provider2 (ref null $trait2)) (param $provider3 (ref null $trait3)) (param $provider4 (ref null $trait4)) (result i32)
    (call $f1 (local.get $l0) (local.get $provider0) (local.get $provider1) (local.get $provider2) (local.get $provider3) (local.get $provider4))
  )

  (func $fv2 (type $sig0) (param $env anyref) (param $l0 i32) (param $provider0 (ref null $trait0)) (param $provider1 (ref null $trait1)) (param $provider2 (ref null $trait2)) (param $provider3 (ref null $trait3)) (param $provider4 (ref null $trait4)) (result i32)
    (call $f2 (local.get $l0) (local.get $provider0) (local.get $provider1) (local.get $provider2) (local.get $provider3) (local.get $provider4))
  )

  (func $f3 (export "c7") (param $l0 i32) (param $provider0 (ref null $trait0)) (param $provider1 (ref null $trait1)) (param $provider2 (ref null $trait2)) (param $provider3 (ref null $trait3)) (param $provider4 (ref null $trait4)) (result i32)
    (call $f2 (local.get $l0) (local.get $provider0) (local.get $provider1) (local.get $provider2) (local.get $provider3) (local.get $provider4))
  )

  (func $fv3 (type $sig0) (param $env anyref) (param $l0 i32) (param $provider0 (ref null $trait0)) (param $provider1 (ref null $trait1)) (param $provider2 (ref null $trait2)) (param $provider3 (ref null $trait3)) (param $provider4 (ref null $trait4)) (result i32)
    (call $f3 (local.get $l0) (local.get $provider0) (local.get $provider1) (local.get $provider2) (local.get $provider3) (local.get $provider4))
  )

  (func $f4 (export "c6") (param $l0 i32) (param $provider0 (ref null $trait0)) (param $provider1 (ref null $trait1)) (param $provider2 (ref null $trait2)) (param $provider3 (ref null $trait3)) (param $provider4 (ref null $trait4)) (result i32)
    (call $f3 (local.get $l0) (local.get $provider0) (local.get $provider1) (local.get $provider2) (local.get $provider3) (local.get $provider4))
  )

  (func $fv4 (type $sig0) (param $env anyref) (param $l0 i32) (param $provider0 (ref null $trait0)) (param $provider1 (ref null $trait1)) (param $provider2 (ref null $trait2)) (param $provider3 (ref null $trait3)) (param $provider4 (ref null $trait4)) (result i32)
    (call $f4 (local.get $l0) (local.get $provider0) (local.get $provider1) (local.get $provider2) (local.get $provider3) (local.get $provider4))
  )

  (func $f5 (export "c5") (param $l0 i32) (param $provider0 (ref null $trait0)) (param $provider1 (ref null $trait1)) (param $provider2 (ref null $trait2)) (param $provider3 (ref null $trait3)) (param $provider4 (ref null $trait4)) (result i32)
    (call $f4 (local.get $l0) (local.get $provider0) (local.get $provider1) (local.get $provider2) (local.get $provider3) (local.get $provider4))
  )

  (func $fv5 (type $sig0) (param $env anyref) (param $l0 i32) (param $provider0 (ref null $trait0)) (param $provider1 (ref null $trait1)) (param $provider2 (ref null $trait2)) (param $provider3 (ref null $trait3)) (param $provider4 (ref null $trait4)) (result i32)
    (call $f5 (local.get $l0) (local.get $provider0) (local.get $provider1) (local.get $provider2) (local.get $provider3) (local.get $provider4))
  )

  (func $f6 (export "c4") (param $l0 i32) (param $provider0 (ref null $trait0)) (param $provider1 (ref null $trait1)) (param $provider2 (ref null $trait2)) (param $provider3 (ref null $trait3)) (param $provider4 (ref null $trait4)) (result i32)
    (call $f5 (local.get $l0) (local.get $provider0) (local.get $provider1) (local.get $provider2) (local.get $provider3) (local.get $provider4))
  )

  (func $fv6 (type $sig0) (param $env anyref) (param $l0 i32) (param $provider0 (ref null $trait0)) (param $provider1 (ref null $trait1)) (param $provider2 (ref null $trait2)) (param $provider3 (ref null $trait3)) (param $provider4 (ref null $trait4)) (result i32)
    (call $f6 (local.get $l0) (local.get $provider0) (local.get $provider1) (local.get $provider2) (local.get $provider3) (local.get $provider4))
  )

  (func $f7 (export "c3") (param $l0 i32) (param $provider0 (ref null $trait0)) (param $provider1 (ref null $trait1)) (param $provider2 (ref null $trait2)) (param $provider3 (ref null $trait3)) (param $provider4 (ref null $trait4)) (result i32)
    (call $f6 (local.get $l0) (local.get $provider0) (local.get $provider1) (local.get $provider2) (local.get $provider3) (local.get $provider4))
  )

  (func $fv7 (type $sig0) (param $env anyref) (param $l0 i32) (param $provider0 (ref null $trait0)) (param $provider1 (ref null $trait1)) (param $provider2 (ref null $trait2)) (param $provider3 (ref null $trait3)) (param $provider4 (ref null $trait4)) (result i32)
    (call $f7 (local.get $l0) (local.get $provider0) (local.get $provider1) (local.get $provider2) (local.get $provider3) (local.get $provider4))
  )

  (func $f8 (export "c2") (param $l0 i32) (param $provider0 (ref null $trait0)) (param $provider1 (ref null $trait1)) (param $provider2 (ref null $trait2)) (param $provider3 (ref null $trait3)) (param $provider4 (ref null $trait4)) (result i32)
    (call $f7 (local.get $l0) (local.get $provider0) (local.get $provider1) (local.get $provider2) (local.get $provider3) (local.get $provider4))
  )

  (func $fv8 (type $sig0) (param $env anyref) (param $l0 i32) (param $provider0 (ref null $trait0)) (param $provider1 (ref null $trait1)) (param $provider2 (ref null $trait2)) (param $provider3 (ref null $trait3)) (param $provider4 (ref null $trait4)) (result i32)
    (call $f8 (local.get $l0) (local.get $provider0) (local.get $provider1) (local.get $provider2) (local.get $provider3) (local.get $provider4))
  )

  (func $f9 (export "c1") (param $l0 i32) (param $provider0 (ref null $trait0)) (param $provider1 (ref null $trait1)) (param $provider2 (ref null $trait2)) (param $provider3 (ref null $trait3)) (param $provider4 (ref null $trait4)) (result i32)
    (call $f8 (local.get $l0) (local.get $provider0) (local.get $provider1) (local.get $provider2) (local.get $provider3) (local.get $provider4))
  )

  (func $fv9 (type $sig0) (param $env anyref) (param $l0 i32) (param $provider0 (ref null $trait0)) (param $provider1 (ref null $trait1)) (param $provider2 (ref null $trait2)) (param $provider3 (ref null $trait3)) (param $provider4 (ref null $trait4)) (result i32)
    (call $f9 (local.get $l0) (local.get $provider0) (local.get $provider1) (local.get $provider2) (local.get $provider3) (local.get $provider4))
  )
      ...
      (block $break0
        (loop $loop0
          ...
          (local.set $l6 (block (result i32)
            (local.set $tmp12 (call $hd.add_i32 (local.get $l6) (call $f9 (block (result i32)
          ...
          ) (local.get $l0) (local.get $l1) (local.get $l2) (local.get $l3) (local.get $l4))))
