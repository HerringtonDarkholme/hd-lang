;; commit bd985d7; command: hd build --wat generated 2-site CFG probe (step!(v) + 0); date: 2026-09-25T20:50:10Z
(module
...
(func $hd.suspension_drive (param $frame (ref null $hd.suspension)) (result anyref)
  ...
  (func $f1 (result (ref null $s1))
    ...
    (struct.new $s1 (i32.const 0) (i32.const 0) (i32.const 0) (i32.const 0) (i32.const 0) (i32.const 0) (i32.const 0) (i32.const 0) (i32.const 0) (i32.const 0) (i32.const 0) (i32.const 0) (i32.const 0) (i32.const 0) (ref.null $s0) (ref.null $s0) (i32.const 0))
  )
  ...
  (func $poll1 (param $frame (ref null $s1)) (result i32)
    ...
    (if (i32.le_u (local.get $resume-state) (i32.const 4))
      (then (local.set $pc (i32.const 11)))
      (else
          ...
          (then
            (if (i32.eqz (call $poll0 (struct.get $s1 $s1child0 (local.get $frame))))
              (then
                ...
                (call $hd.trace (i32.const 1) (i32.const 6))
                (return (i32.const 0))))
            (local.set $l8 (struct.get $s0 $s0result (struct.get $s1 $s1child0 (local.get $frame))))
              ...
              (then
                (if (i32.eqz (call $poll0 (struct.get $s1 $s1child1 (local.get $frame))))
                  (then
                    ...
                    (call $hd.trace (i32.const 1) (i32.const 6))
                    (return (i32.const 0))))
                (local.set $l4 (struct.get $s0 $s0result (struct.get $s1 $s1child1 (local.get $frame))))
    ...
    (loop $cfg
      (if (i32.eq (local.get $pc) (i32.const 0))
        (then
          ...
          (struct.set $s1 $s1result (local.get $frame) (local.get $l11))
      ...
      (if (i32.eq (local.get $pc) (i32.const 1))
        (then
          (local.set $l2 (call $hd.add_i32 (local.get $l9) (local.get $l10)))
      ...
      (if (i32.eq (local.get $pc) (i32.const 3))
        (then
          (local.set $l9 (local.get $l8))
          (local.set $pc (i32.const 2))
          (br $cfg)
        ))
      (if (i32.eq (local.get $pc) (i32.const 4))
        (then
          (struct.set $s1 $s1child0 (local.get $frame) (call $f0 (local.get $l7)))
          (if (i32.eqz (call $poll0 (struct.get $s1 $s1child0 (local.get $frame))))
            (then
              (struct.set $s1 $s1l0 (local.get $frame) (local.get $l0))
              (struct.set $s1 $s1l1 (local.get $frame) (local.get $l1))
      ...
      (if (i32.eq (local.get $pc) (i32.const 6))
        (then
          (local.set $l1 (call $hd.add_i32 (local.get $l5) (local.get $l6)))
      ...
      (if (i32.eq (local.get $pc) (i32.const 9))
        (then
          (struct.set $s1 $s1child1 (local.get $frame) (call $f0 (local.get $l3)))
          (if (i32.eqz (call $poll0 (struct.get $s1 $s1child1 (local.get $frame))))
            (then
              (struct.set $s1 $s1l0 (local.get $frame) (local.get $l0))
              (struct.set $s1 $s1l1 (local.get $frame) (local.get $l1))
