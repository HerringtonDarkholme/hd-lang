...
| -- | -------- | ---- | ----- | ------------ |
| [F-100](../findings/F-100-open-issues-closed-in-implementation-commit.md) | minor | spec | The first implementation commit closed three open design issues with no fixtures |  |
...
| [F-102](../findings/F-102-marker-lines-encode-mvp-spans.md) | minor | test-integrity | Marker lines are normative, but the spec defines no location rule and every checked line equals the MVP's span |  |
...
| [F-151](../findings/F-151-diagnostic-marker-satisfied-by-warning.md) | minor | test-integrity | A `# diagnostic:` marker is satisfied by a warning with the same code |  |
| [F-152](../findings/F-152-panic-code-matched-anywhere-in-output.md) | minor | test-integrity | Panic expectations match the code anywhere in stdout or stderr |  |
| [F-153](../findings/F-153-runtime-error-panic-accepts-crashes.md) | major | test-integrity | `# panic: runtime-error` accepts any failing exit, including compiler crashes |  |
| [F-154](../findings/F-154-scenario-runs-skip-test-blocks.md) | minor | test-integrity | Runtime scenario cases never run their test blocks |  |
...
| [F-156](../findings/F-156-expect-result-compares-stdout.md) | note | test-integrity | `# expect-result` compares all of stdout, not the entry's return value |  |
...
| [F-200](../findings/F-200-fixture-format-defined-outside-spec.md) | major | spec | Fixture directives and the runner command contract are defined outside spec/ |  |
...
| [F-202](../findings/F-202-expect-result-uses-host-formatting.md) | major | test-integrity | `expect-result` compares JavaScript formatting of Wasm return values, not a specified rendering |  |
| [F-204](../findings/F-204-panic-lines-never-checked.md) | minor | test-integrity | Three panic fixtures mark a line that does not cause the panic |  |
...
| [F-206](../findings/F-206-reference-parser-lexical-gaps.md) | minor | spec | The reference parser disagrees with spec/01 on four lexical rules |  |
| [F-207](../findings/F-207-located-check-needs-verbatim-path.md) | minor | test-integrity | The located-diagnostic check requires the implementation to echo the runner's absolute path verbatim |  |
| [F-208](../findings/F-208-reject-cases-with-extra-errors.md) | minor | test-integrity | Four reject cases repeat their code on other lines, so the marker does not isolate one construct |  |
| [F-209](../findings/F-209-parse-fixtures-run-through-check.md) | note | test-integrity | test/fixtures has no phase, so lexer and parser rejections run through `check` |  |
| [F-210](../findings/F-210-weak-runtime-oracles.md) | minor | test-integrity | Nineteen fixtures claim runtime or implementation behavior their oracle cannot observe |  |
| [F-211](../findings/F-211-duplicate-test-names.md) | note | test-integrity | 118 fixtures share `# test:` names, so portable failures cannot be traced to a file |  |
| [F-212](../findings/F-212-harness-hooks-underspecified.md) | minor | spec | Two harness hooks cannot be built from their description, and one is implemented nowhere |  |
...
| [F-260](../findings/F-260-traits-fixture-passing-unselected.md) | note | coverage | `typing/valid/traits.hd` passes but is not selected |  |
| [F-261](../findings/F-261-identity-rejects-mut-operands.md) | major | correctness | `is` rejects operands with `mut` access | F-353 |
| [F-262](../findings/F-262-f64-relational-codegen-crash.md) | blocker | correctness | Any `f64` `<`, `<=`, `>`, or `>=` crashes code generation | F-160 |
| [F-263](../findings/F-263-primitives-fail-prelude-bounds.md) | major | correctness | Primitive types do not satisfy `PartialEq`, `PartialOrd`, or `Display` bounds | F-350, F-500 |
...
| [F-300](../findings/F-300-ref-parser-nested-function-type.md) | major | spec | Reference parser rejects `fn() -> fn() -> T` unless a requirement clause is present |  |
| [F-301](../findings/F-301-ref-parser-unicode-escape.md) | major | spec | Reference parser rejects `\u{...}` escapes that chapter 01 defines | F-206 |
| [F-302](../findings/F-302-ref-parser-context-entry-order.md) | major | spec | Reference parser applies argument-order to context entries and rejects the chapter 11 example | F-360, found independently by the fuzzer |
| [F-303](../findings/F-303-ref-parser-lone-dollar.md) | minor | spec | Reference parser accepts an unescaped `$` that does not start an interpolation | F-206 |
...
| [F-313](../findings/F-313-diagnostic-inventory-incomplete.md) | major | spec | The normative diagnostic inventory omits most codes that hd and the reference parser emit |  |
...
| [F-358](../findings/F-358-reference-parser-string-in-interpolation.md) | minor | spec | The reference parser rejects a string literal inside `${...}` |  |
| [F-359](../findings/F-359-reference-parser-nested-named-arguments.md) | minor | spec | The reference parser flags `g(f(a=1, b=2), 3)` as `argument-order` |  |
| [F-360](../findings/F-360-reference-parser-context-spread-order.md) | minor | spec | The reference parser rejects `$.with(Tag=x, ...ctx)` |  |
| [F-361](../findings/F-361-shared-data-variant-identity.md) | note | spec | Is a payload-free variant with shared enum data canonical for `is`? |  |
...
| [F-405](../findings/F-405-decorator-message-says-not-top-level.md) | minor | correctness | Every decorator is rejected as "only valid on top-level declarations" |  |
| [F-406](../findings/F-406-panic-categories-without-producer.md) | note | spec | Four stable panic categories have no producer, and one panic has no category |  |
