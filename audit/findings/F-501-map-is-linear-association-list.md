...
Recommendation: implementation change. Use a hash index next to the insertion-ordered key and value arrays, keeping iteration order. Decided rule (spec/10-modules.md, Prelude): map lookup, insertion, and removal take expected amortized O(1) time.
