...
Recommendation: implementation change. On Pending, the entry export should return to the host (as `__hd_poll` does) instead of looping in `$driveN`. Spec 11 already requires a waker-driven host executor.
