;; commit bd985d7; hd build --wat b1-scalar.hd; 2026-09-25T20:54:02.908Z
(module
...
(func $hd.suspension_drive (param $frame (ref null $hd.suspension)) (result anyref)
  ...
  (func $f0 (export "fib") (param $l0 i32) (result i32)
    (local $tmp0 i32)
    (if (result i32) (block (result i32) (local.set $tmp0 (if (result i32) (i32.lt_s (local.get $l0) (i32.const 2)) (then (i32.const -1)) (else (if (result i32) (i32.gt_s (local.get $l0) (i32.const 2)) (then (i32.const 1)) (else (i32.const 0)))))) (i32.eq (local.get $tmp0) (i32.const -1)))
      (then
        (local.get $l0)
      )
      (else
        (call $hd.add_i32 (call $f0 (call $hd.sub_i32 (local.get $l0) (i32.const 1))) (call $f0 (call $hd.sub_i32 (local.get $l0) (i32.const 2))))
      )
    )
  )
