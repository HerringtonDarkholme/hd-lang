;; commit bd985d7; hd build --wat b4-plain.hd; 2026-09-25T20:54:19.271Z
(module
...
(func $hd.suspension_drive (param $frame (ref null $hd.suspension)) (result anyref)
  ...
  (func $f0 (export "step") (param $l0 i32) (result i32)
    ...
    (block $break0
      (loop $loop0
        ...
        (local.set $l1 (block (result i32)
          (local.set $tmp2 (call $hd.add_i32 (local.get $l1) (call $f0 (block (result i32)
