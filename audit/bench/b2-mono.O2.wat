;; commit bd985d7; binaryen -O2 of b2-mono.hd; 2026-09-25T20:54:07.471Z
(module
 (rec
  (type $sig0 (func (param anyref i32 i32) (result i32)))
  (type $sig1 (func (param anyref (ref null $hd.vector)) (result i32)))
 ...
 (func $f0 (type $34) (param $0 i32) (param $1 i32) (result i32)
  (local.set $0
   (call $hd.add_i32
    (local.get $0)
    (local.get $1)
