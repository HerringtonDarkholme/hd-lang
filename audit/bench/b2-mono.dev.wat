;; commit bd985d7; hd build --wat b2-mono.hd; 2026-09-25T20:54:07.500Z
(module
  (import "hd" "panic" (func $hd.panic (param i32)))
  (rec
    (type $sig0 (func (param anyref) (param i32) (param i32) (result i32)))
    (type $sig1 (func (param anyref) (param (ref null $hd.vector)) (result i32)))
...
(func $hd.suspension_drive (param $frame (ref null $hd.suspension)) (result anyref)
  ...
  (elem declare func $fv0 $fv1 $fv2)

  (func $f0 (export "plus") (param $l0 i32) (param $l1 i32) (result i32)
    (local $tmp0 i32)
    (local $tmp1 i32)
    (block (result i32)
  ...
  (func $fv0 (type $sig0) (param $env anyref) (param $l0 i32) (param $l1 i32) (result i32)
  ...
  (func $f1 (param $l0 (ref null $hd.vector)) (result i32)
    ...
    (block $break0
      (loop $loop0
        (br_if $break0 (i32.eqz (block (result i32) (local.set $tmp0 (if (result i32) (i32.lt_s (local.get $l2) (struct.get $hd.vector $hd.vector-size (ref.as_non_null (local.get $l0)))) (then (i32.const -1)) (else (if (result i32) (i32.gt_s (local.get $l2) (struct.get $hd.vector $hd.vector-size (ref.as_non_null (local.get $l0)))) (then (i32.const 1)) (else (i32.const 0)))))) (i32.eq (local.get $tmp0) (i32.const -1)))))
        (local.set $l1 (call $f0 (struct.get $hd.box-i32 $hd.box-i32-value (ref.cast (ref $hd.box-i32) (call $hd.vector_get (ref.as_non_null (local.get $l0)) (local.get $l2)))) (local.get $l1)))
  ...
  (func $fv1 (type $sig1) (param $env anyref) (param $l0 (ref null $hd.vector)) (result i32)
    ...
    (block $break2
      (loop $loop2
        ...
        (local.set $l3 (block (result i32)
          (local.set $tmp1 (call $hd.add_i32 (local.get $l3) (call $f1 (local.get $l0))))
