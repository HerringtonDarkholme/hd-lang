;; commit bd985d7; hd build --wat b3-req1.hd; 2026-09-25T20:54:09.928Z
(module
...
(func $hd.suspension_drive (param $frame (ref null $hd.suspension)) (result anyref)
  ...
  (func $f10 (export "main") (result i32)
    ...
    (block (result i32)
      ...
      (block $break0
        (loop $loop0
          (br_if $break0 (i32.eqz (block (result i32) (local.set $tmp6 (if (result i32) (i32.lt_s (local.get $l1) (i32.const 2000000)) (then (i32.const -1)) (else (if (result i32) (i32.gt_s (local.get $l1) (i32.const 2000000)) (then (i32.const 1)) (else (i32.const 0)))))) (i32.eq (local.get $tmp6) (i32.const -1)))))
